...
namespace uuuuuuuuuuuullllllllllllyyyyyyyyyyyyy
{
    internal class Program
    {
        class SmsMessage
        {
            ...
            public void SendMessage()
            {
                ...
                Console.WriteLine($"Cообщение '{_messagetext}'отправлено.");
            }
        ...
        {
            SmsMessage sms = new SmsMessage("Списание по тарифу - 230 руб.", 105, 8, 9.6);
            sms.SendMessage();
